 ...
 */
#ifndef CUNB_CHANNEL_H
#define CUNB_CHANNEL_H
...
/**
  * Allow logging of CunbChannelParameters like with any other data type.
  */
 ...
 */
class CunbChannel : public Channel
{
public:
  // TypeId
  ...
  /**
    ...
    */
  void Add (Ptr<CunbPhy> phy);

  /**
    * Remove a physical layer from the CunbChannel.
    *
  ...
  /**
    ...
    */
  void Send (Ptr<CunbPhy> sender, Ptr<Packet> packet, double txPowerDbm,
             CunbTxParameters txParams, Time duration, double frequencyMHz)
  const;
...
private:
  ...
  /**
    ...
    * channel.
    */
  std::vector<Ptr<CunbPhy> > m_phyList;
