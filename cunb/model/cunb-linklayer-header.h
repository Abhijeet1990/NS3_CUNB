#ifndef CUNB_LINKLAYER_HEADER_H
#define CUNB_LINKLAYER_HEADER_H
 ...
 */
class CunbLinkLayerHeader : public Header
{
public:
  ...
  /**
   * Deserialize the contents of the buffer into a CunbLinkLayerHeader object.
   *
